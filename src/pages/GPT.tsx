...
const GPT: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Send webhook
      const webhookResponse = await fetch('https://n8n.srv997647.hstgr.cloud/webhook/f7178db5-3e54-4f7d-a171-277d1d265bfa', {
        method: 'POST',
        headers: {
    ...
    <div className="px-4 py-8 h-[calc(100vh-4rem)] flex animate-fade-in">
      ...
      <div className="flex-1 flex flex-col bg-white rounded-lg shadow-sm border border-neutral-200 overflow-hidden">
        <div className="p-6 border-b border-neutral-200">
          ...
          <p className="text-neutral-500">Test your Pri0r1ty Advisor to see how it will respond using your own data </p>
        </div>
