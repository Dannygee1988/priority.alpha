...
import { Phone, ChevronDown, ChevronUp, Clock, User, TrendingUp, MessageSquare, DollarSign, Tag, Settings, Voicemail, PhoneOff } from 'lucide-react';
  ...
  return (
    <div className="p-8 relative">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-neutral-200 overflow-hidden">
        <div className="grid grid-cols-[2fr_4fr_2fr_1.5fr_2fr_auto] gap-4 px-6 py-4 bg-neutral-50 border-b border-neutral-200 text-sm font-medium text-neutral-700">
          <div>Date</div>
          <div>Subject</div>
            ...
            {filteredCalls.map((call) => (
              <div key={call.id}>
                <div
                  ...
                  className="grid grid-cols-[2fr_4fr_2fr_1.5fr_2fr_auto] gap-4 px-6 py-4 hover:bg-neutral-50 cursor-pointer transition-colors items-center"
                >
