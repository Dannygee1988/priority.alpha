...
import { Twitter, Facebook, Linkedin as LinkedIn, Instagram, Plus, X, Wand2, Image, Calendar, Hash, Type, MessageSquare, Target, Users, TrendingUp } from 'lucide-react';
                ...
                {variables.length > 0 && (
                  <div className="space-y-3">
                    {variables.map((variable) => (
                      <div key={variable.id} className="flex items-center space-x-3 p-3 bg-neutral-50 rounded-lg">
