...
const Chats: React.FC = () => {
  ...
  const loadOpenAIThreads = async () => {
    // This function is no longer needed as we now query threads directly from the database
    // Threads are stored in the assistant_threads table when created
    // and retrieved in the loadMessages function
  };
