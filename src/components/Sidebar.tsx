...
import { Share2, Megaphone, Users, Globe, LayoutDashboard, PoundSterling, Users as Users2, LineChart, UserCog, Calendar, Inbox, Settings, ChevronLeft, ChevronRight, ChevronDown, SquarePen as PenSquare, MessageSquare, Palette, Hash, TrendingUp, CalendarDays, Video, Images, Type, BookOpen, Wrench, FileType2, ScanLine, FileSearch, FileCog, FileText, FileSpreadsheet, FileImage, FileAudio, FileVideo, Printer, Newspaper, CircleUser as UserCircle, Shield, AlertCircle, PenLine, Database, Sparkles, UserPlus, Image, File as FileEdit, FileCheck, Brain, Bot, MessagesSquare, ListFilter, FileUp as FileUser, Bitcoin, Code, Mic, PhoneOutgoing, PhoneIncoming, BarChart3, Beaker } from 'lucide-react';
